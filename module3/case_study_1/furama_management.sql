...
GROUP BY hop_dong_chi_tiet.ma_hop_dong
  ...
  */
  ...
  where (dich_vu.ma_dich_vu not in(select dich_vu.ma_dich_vu from dich_vu join hop_dong on dich_vu.ma_dich_vu = hop_dong.ma_dich_vu where(year(ngay_lam_hop_dong)=2021 and month(ngay_lam_hop_dong)in (1,2,3))) 
  and hop_dong.ngay_lam_hop_dong not in(select hop_dong.ngay_lam_hop_dong where (year(ngay_lam_hop_dong)=2021 and month(ngay_lam_hop_dong)in (1,2,3))))
